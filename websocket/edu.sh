...
# Link Hosting Kalian
hasandnc="raw.githubusercontent.com/Rolka111111/scripts/main/websocket"

# Getting Proxy Template
wget -q -O /usr/local/bin/ws-nontls https://${hasandnc}/websocket.py
chmod +x /usr/local/bin/ws-nontls

# Installing Service
cat > /etc/systemd/system/ws-nontls.service << END
[Unit]
Description=Python Proxy Mod By JuraganSSH
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-ovpn https://${hasandnc}/ws-ovpn.py
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-tls https://${hasandnc}/ws-tls
