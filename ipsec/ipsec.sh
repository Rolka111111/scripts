...
# ==================================================
# Link Hosting Kalian
hasandnc="raw.githubusercontent.com/Rolka111111/scripts/main/ipsec"
...
wget -O /usr/bin/addl2tp https://${hasandnc}/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://${hasandnc}/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://${hasandnc}/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://${hasandnc}/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://${hasandnc}/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://${hasandnc}/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
touch /var/lib/hasandancow/data-user-l2tp
touch /var/lib/hasandancow/data-user-pptp
rm -f /root/ipsec.sh
