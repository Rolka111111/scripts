...
cat /etc/openvpn/server/easy-rsa/pki/issued/client.crt >> /etc/openvpn/tcp.ovpn
echo '</cert>' >> /etc/openvpn/tcp.ovpn
echo '<key>' >> /etc/openvpn/tcp.ovpn
cat /etc/openvpn/server/easy-rsa/pki/private/client.key >> /etc/openvpn/tcp.ovpn
echo '</key>' >> /etc/openvpn/tcp.ovpn
...
cat /etc/openvpn/server/easy-rsa/pki/issued/client.crt >> /etc/openvpn/udp.ovpn
echo '</cert>' >> /etc/openvpn/udp.ovpn
echo '<key>' >> /etc/openvpn/udp.ovpn
cat /etc/openvpn/server/easy-rsa/pki/private/client.key >> /etc/openvpn/udp.ovpn
echo '</key>' >> /etc/openvpn/udp.ovpn
...
cat /etc/openvpn/server/easy-rsa/pki/issued/client.crt >> /etc/openvpn/ssl.ovpn
echo '</cert>' >> /etc/openvpn/ssl.ovpn
echo '<key>' >> /etc/openvpn/ssl.ovpn
cat /etc/openvpn/server/easy-rsa/pki/private/client.key >> /etc/openvpn/ssl.ovpn
echo '</key>' >> /etc/openvpn/ssl.ovpn
