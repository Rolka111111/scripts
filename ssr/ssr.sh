...
# Link Hosting Kalian
hasandnc="raw.githubusercontent.com/Rolka111111/scripts/main/ssr"
...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://${hasandnc}/ssrmu"
...
Install_SSR
wget -O /usr/bin/ssr https://${hasandnc}/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/addssr https://${hasandnc}/addssr.sh && chmod +x /usr/bin/addssr
wget -O /usr/bin/delssr https://${hasandnc}/delssr.sh && chmod +x /usr/bin/delssr
wget -O /usr/bin/renewssr https://${hasandnc}/renewssr.sh && chmod +x /usr/bin/renewssr
