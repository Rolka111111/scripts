...
# ==================================================
# Link Hosting Kalian
hasandnc="raw.githubusercontent.com/Rolka111111/scripts/main/wireguard"
...
echo -e "${Info} Wireguard Script By JuraganSSH"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://${hasandnc}/addwg.sh"
wget -O delwg "https://${hasandnc}/delwg.sh"
wget -O renewwg "https://${hasandnc}/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
