#!/bin/bash
#shadowsocks-libev obfs install by JuraganSSH
...
# Link Hosting Kalian
hasandnc="raw.githubusercontent.com/Rolka111111/scripts/main/shadowsocks"
...
cd /usr/bin
wget -O addss "https://${hasandnc}/addss.sh"
wget -O delss "https://${hasandnc}/delss.sh"
wget -O cekss "https://${hasandnc}/cekss.sh"
wget -O renewss "https://${hasandnc}/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x renewss
